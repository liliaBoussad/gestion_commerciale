...
PRIX_PUBLIC = {
    ...
    276: 9460.00,    # CEM I 42.5 N-LH/SR5 — Sac 50kg Fardelisé 2.2T
    277: 7100.00,    # CEM I 52.5 N-SR5 — Sac 50kg
    278: 6300.00,    # CEM I 52.5 N-SR5 — Vrac
    279: 6486.60,    # CEM I 52.5 N-SR5 — Big-Bag charge client
    280: 7250.00,    # CEM I 52.5 N-SR5 — Sac 50kg Fardelisé 2.2T
    281: 5750.00,    # CEM II/A-L 32.5 N — Sac 25kg
    282: 6000.00,    # CEM II/A-L 32.5 N — Sac 25kg Fardelisé 1.45T
    283: 6000.00,    # CEM II/A-L 32.5 N — Sac 50kg Fardelisé
    ...
    288: 6790.00,    # CEM II/A-L 42.5 N — Sac 25kg Fardelisé 1.45T
    289: 6495.00,    # CEM II/A-L 42.5 N — Sac 50kg Fardelisé 2.2T
    ...
    266: 6790.00,    # CEM II/A-L 42.5 R — Sac 25kg Fardelisé 1.45T
    267: 6495.00,    # CEM II/A-L 42.5 R — Sac 50kg Fardelisé 2.2T
...
# None = pas de remise (tiret dans Excel)
# ============================================================
REMISES_SODISMAC = {
    274: 7,  275: 10, 276: 7,
...
# --- Tarif Public : une règle prix fixe par variante ---
if pl_public:
    ...
    print(f"Tarif Public : {len(PRIX_PUBLIC)} règles créées")
else:
    print("Tarif Public INTROUVABLE — vérifie le nom exact dans Odoo")

# --- SODISMAC / Autre Client / Exportation : remises % ---
def creer_remises(pricelist, remises, nom):
    ...
    for product_id, remise in remises.items():
        ...
        count += 1
    print(f"{nom} : {count} règles créées")
